...
<body class="min-h-screen bg-[#050404] select-none flex items-center justify-center transition-colors duration-400 font-size-standard p-0 sm:p-4" id="body-main">
    @yield('content')
