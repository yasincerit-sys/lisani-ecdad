...
class ProgressController extends Controller
{
    ...
    public function sync(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'recent_tests.*.bolum' => ['nullable'],
            'recent_tests.*.step' => ['nullable'],
            'recent_tests.*.id' => ['nullable'],
            'recent_tests.*.wrong_items' => ['nullable', 'array'],
            'recent_tests.*.wrong_items.*.type' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.word' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.prompt' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.questionText' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.label' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.correct' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.userAnswer' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.tip' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.grammarTopic' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.studyTopic' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.studyTopicId' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.studyHint' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.bolum' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.bolumTitle' => ['nullable', 'string'],
            'recent_tests.*.wrong_items.*.options' => ['nullable', 'array'],
            'recent_tests.*.wrong_items.*.replay' => ['nullable', 'array'],
        ]);
